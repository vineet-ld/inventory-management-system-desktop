 ...
 * @author Vineet
 */
public class ViewOrderDetailDialog extends javax.swing.JDialog {
     ...
     */
    public ViewOrderDetailDialog(java.awt.Frame parent, boolean modal,
            Order order) {
    ...
    public void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewOrderDetailDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ViewOrderDetailDialog dialog
                        = new ViewOrderDetailDialog(
