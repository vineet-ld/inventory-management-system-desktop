 ...
 * @author Vineet
 */
public class ChangeQuantityDialog extends javax.swing.JDialog {

    private OrderItem orderItem;
    private CreateOrderDialog createOrderDialog;

    /**
     * Creates new form ChangeQuantityDialog
     */
    public ChangeQuantityDialog(java.awt.Frame parent, boolean modal,
            OrderItem orderItem, CreateOrderDialog createOrderDialog) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        changeQuantityBtn = new com.alee.laf.button.WebButton();
        ...
        webLabel5.setText("Enter New Quantity");
        ...
        changeQuantityBtn.setForeground(new java.awt.Color(0, 0, 255));
        changeQuantityBtn.setText("Change");
        changeQuantityBtn.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(changeQuantityBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 149, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(webLabel5, javax.swing.GroupLayout.PREFERRED_SIZE, 156, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(quantitySpinner, javax.swing.GroupLayout.DEFAULT_SIZE, 38, Short.MAX_VALUE)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(changeQuantityBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 43, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(23, 23, 23))
        );
    ...
    private void changeQuantityBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_changeQuantityBtnActionPerformed
        ...
        try {
            ...
            createOrderDialog.populateOrderItems();
            this.dispose();
    ...
    public void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChangeQuantityDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ChangeQuantityDialog dialog
                        = new ChangeQuantityDialog(new javax.swing.JFrame(),
                                true, orderItem, createOrderDialog);
    ...
    private com.alee.laf.button.WebButton changeQuantityBtn;
